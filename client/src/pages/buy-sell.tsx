        ...
        >
          <div className="flex gap-3 justify-center items-center">
            ...
            >
              ...
              <div className="space-y-1">
                <div className={`flex items-center text-xs ${selectedType === 'apartment' ? 'text-white/90' : 'text-gray-700'}`}>
                  <div className={`w-1 h-1 rounded-full mr-2 ${selectedType === 'apartment' ? 'bg-white/70' : 'bg-black'}`}></div>
                  <span>City skyline views</span>
                </div>
                <div className={`flex items-center text-xs ${selectedType === 'apartment' ? 'text-white/90' : 'text-gray-700'}`}>
                  <div className={`w-1 h-1 rounded-full mr-2 ${selectedType === 'apartment' ? 'bg-white/70' : 'bg-black'}`}></div>
